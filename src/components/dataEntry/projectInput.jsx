...
class ProjectInput extends Component {
    ...
    render() {
        return (
            <React.Fragment>
                <select id="project" name="project" onChange={this.props.changeHandler} style={this.props.style ? this.props.style : { width: '180px' }} defaultValue={this.props.defaultValue}>
